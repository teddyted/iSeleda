...
public class MenuBar extends JMenuBar {
    ...
    private void initFileMenu(PixelitorWindow pixelitorWindow) {
        ...
        // MSL Dictionary
        String mslName = "MSL Dictionary ليلة القدر";
        Action mslAction;
        mslAction = new MenuAction (mslName) {
            @Override
                    void onClick() {
...
//                        ImageLayer newLayer = new ImageLayer.ImageLayer(this, "/Users/teddyted/Pictures/mathLove.jpeg", 200, 200);

//                        addLayerNoGUI(newLayer);
//                        activeLayer = newLayer;
                        //ImageLayer.ImageLayer(Composition comp, "/Users/teddyted/Pictures/mathLove.jpeg", "Math", 200, 200);

                        //OpenSaveManager.openFile("/Users/teddyted/Pictures/mathLove.jpeg");
                        //throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
                    }
        };
        
        createMenuItem(mslAction, fileMenu, EnabledIf.ACTION_ENABLED);
        fileMenu.addSeparator();
